...
tech_stack:
  added: [pnpm-workspaces, @agentforge/shared]
...
pnpm monorepo with corrected .tsx extensions, @agentforge/shared types package, Go Makefile, and env template — TypeScript compiles clean.
